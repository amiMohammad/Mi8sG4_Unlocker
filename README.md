...
本脚本目前已精准适配以下 **3 款** 骁龙 8 sGen4 平台设备：
...
* **机型目录对齐：** 脚本运行后会根据你选择的机型自动调用对应文件夹（如 `Redmiturbo4pro`、`Xiaomipad8` 等）内的特定配置文件。
...
如果你在上述 3 款机型上遇到“未识别设备”或脚本报错，请提交 **Issue** 并附上报错截图，我会针对该机型文件夹内的逻辑进行修复。
## 👥 贡献者名单 (Contributors)
